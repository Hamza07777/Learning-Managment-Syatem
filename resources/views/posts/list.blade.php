      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a name="" id="" class="btn btn-primary" href="{{  route('post.create')  }}" role="button">Add Post</a>
          </div>
            ...
            <table class="display" id="advance-1" >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td >
                    <label class="switch">
                      <input type="checkbox" onclick="checkFluency({{ $post->id }})"  id="{{ $post->id  }}"
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" data-action="{{route('postDestroy',$post->id)}}" class="deleteRecord">
            ...
            <div class="page-wrapper compact-wrapper" id="pageWrapper">
                ...
                <div class="error-wrapper">
                    <div class="container"><img class="img-100" src="{{ asset('public/assets/images/other-images/sad.png') }}" alt="">
                        ...
                        <h2 class="font-info">Posts are Not Found</h2>
                        </div>
                        <div class="col-md-8 offset-md-2">
                        <p class="sub-content">Posts are not yet added for further Proceding Add Post</p>
                        </div>
                    <div>
                        <a name="" id="" class="btn btn-primary" href="{{ route('post.create') }}" role="button">Add Post</a>
