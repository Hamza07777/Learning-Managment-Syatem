      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form method="post" action="{{url('multiplecourse_tagdelete')}}">
                {{ csrf_field() }}
            ...
            <table class="display" id="advance-1" >
              ...
              <tbody>
                @foreach($course_tag as $course_tag)
                <tr>
                    <td><input name='id[]' type="checkbox" class="chk-ani" 
                        value="<?php echo $course_tag->id; ?>"></td>
                  <td>{{ $course_tag->course_namee->name }}</td>
                  <td>{{ $course_tag->tag_name->name }}</td>
                  <td >
                    <label class="switch">
                      <input type="checkbox" onclick="checkFluency({{ $course_tag->id }})"  id="{{ $course_tag->id  }}"
                      
                        @if($course_tag->status=="active")         
                            checked
            ...
            <div class="page-wrapper compact-wrapper" id="pageWrapper">
                ...
                <div class="error-wrapper">
                    <div class="container"><img class="img-100" src="{{ asset('public/assets/images/other-images/sad.png') }}" alt="">
                        ...
                        <h2 class="font-info">Tags in Courses are Not Found</h2>
                        </div>
