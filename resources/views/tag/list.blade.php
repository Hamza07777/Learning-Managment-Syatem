      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a name="" id="" class="btn btn-primary" href="{{  route('tag.create')  }}" role="button">Add Tag</a>
          </div>

        </div>
        <div class="card-body">
          <div class="table-responsive">
            <form method="post" action="{{url('multipletag-destroydelete')}}">
                {{ csrf_field() }}
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" data-action="{{route('tagDestroy',$tag->id)}}" class="deleteRecord">
            ...
            <div class="page-wrapper compact-wrapper" id="pageWrapper">
                ...
                <div class="error-wrapper">
                    <div class="container"><img class="img-100" src="{{ asset('public/assets/images/other-images/sad.png') }}" alt="">
                        ...
                        <h2 class="font-info">Tags are Not Found</h2>
                        </div>
                        <div class="col-md-8 offset-md-2">
                        <p class="sub-content">Tags are not yet added for further Proceding Add Tag</p>
                        </div>
                    <div>
                        <a name="" id="" class="btn btn-primary" href="{{ route('tag.create') }}" role="button">Add Tag</a>
