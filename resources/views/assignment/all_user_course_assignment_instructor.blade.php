      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a name="" id="" class="btn btn-primary" href="{{  route('instructor-assignment.create')  }}" role="button">Add Assignment</a>
          </div>

        </div>
        <div class="card-body">
          <form method="POST" action="{{route('all_user_course_instructor_assignment_filter')}}" class="theme-form">
            @csrf
            ...
            <table class="display" id="advance-1" >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $user_course_assignment_marks->assignment_name }}</td>
                  <td>{{ $user_course_assignment_marks->assignment_assignment_total_marks }}</td>
                  <td>{{ $user_course_assignment_marks->user_name }}</td>
                  <td>{{ $user_course_assignment_marks->courses_name }}</td>
                  ...
                  <td>
                    <a href="{{route('add_assignment_mark_view_instructor',$user_course_assignment_marks->id)}}">
