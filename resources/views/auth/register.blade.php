                    ...
                    <div class="cont text-center s--signup">
                      <div>
                        <form method="POST" action="{{ route('login') }}" class="theme-form">
                          ...
                          <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="someone@gmail.com">
                            @error('email')
                      ...
                      <div class="sub-cont">
                        ...
                        <div>
                            ...
                            <h6 class="text-center">Enter your User Name,Email and Password For Signup</h6>
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">

                                        <input id="name" type="text" placeholder="User Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" >
