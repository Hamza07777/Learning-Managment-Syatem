      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a name="" id="" class="btn btn-primary" href="{{  route('category.create')  }}" role="button">Add Category</a>
          </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <form method="post" action="{{url('multiplecategory-destroydelete')}}">
                {{ csrf_field() }}
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" data-action="{{route('categoryDestroy',$category->id)}}" class="deleteRecord">
            ...
            <div class="page-wrapper compact-wrapper" id="pageWrapper">
                ...
                <div class="error-wrapper">
                    <div class="container"><img class="img-100" src="{{ asset('public/assets/images/other-images/sad.png') }}" alt="">
                        ...
                        <p class="sub-content">Categories are not yet added for further Proceding Add Category</p>
                        </div>
                    <div>
                        <a name="" id="" class="btn btn-primary" href="{{ route('category.create') }}" role="button">Add Category</a>
