      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="float-right">
            <a name="" id="" class="btn btn-primary" href="{{  route('location.create')  }}" role="button">Add Location</a>
          </div>

        </div>
        <div class="card-body">
          <div class="table-responsive">
            <form method="post" action="{{url('multiplelocation-destroydelete')}}">
                {{ csrf_field() }}
              ...
              <tbody>
                ...
                <tr>
                    <td><input name='id[]' type="checkbox" class="chk-ani" 
                        value="<?php echo $location->id; ?>"></td>
                  <td>{{ $location->location }}</td>
                  <td>{{ $location->description }}</td>
                  <td >
                    <label class="switch">
                      <input type="checkbox" onclick="checkFluency({{ $location->id }})"  id="{{ $location->id  }}"
                  ...
                  <td>
                    ...
                    <a href="javascript:void(0)" data-action="{{route('locationDestroy',$location->id)}}" class="deleteRecord">
            ...
            <div class="page-wrapper compact-wrapper" id="pageWrapper">
                ...
                <div class="error-wrapper">
                    <div class="container"><img class="img-100" src="{{ asset('public/assets/images/other-images/sad.png') }}" alt="">
                        ...
                        <h2 class="font-info">Locations are Not Found</h2>
                        </div>
                        <div class="col-md-8 offset-md-2">
                        <p class="sub-content">Locations are not yet added for further Proceding Add Location</p>
                        </div>
                    <div>
                        <a name="" id="" class="btn btn-primary" href="{{ route('location.create') }}" role="button">Add Location</a>
